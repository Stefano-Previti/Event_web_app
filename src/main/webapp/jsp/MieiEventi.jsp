...
<body>
    <div class="navbar">
        ...
        <a class="active" href="<%=JView.MieiEventiCTL%>">Miei eventi</a>
     ...
     <div class="container">
        <h1>Elenco miei eventi</h1>
        <div class="search-form">
            <form action="<%=JView.SearchCTL%>" method="get">
                <input type="text" name="searchTerm" placeholder="Cerca evento...">
                <input type="submit" value="Cerca" class="submit-button" style="height: 40px; width: 80px;">
            </form>
        </div>
        <% Map<String, EventBean> eventsMap = (Map<String, EventBean>) session.getAttribute("mymap"); %>
            ...
            <% for (Map.Entry<String, EventBean> entry : eventsMap.entrySet()) { %>
                ...
                <div class="rectangle">
                    ...
                    <p>Descrizione: <%= eventBean.getDescrizione() %></p>
                          <form action="<%=JView.MieiEventiCTL%>" method="post" class="elimina">
                            <input type="hidden" name="titol" value="<%= titolo %>">
